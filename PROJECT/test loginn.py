...
class PharmaCareApp:
    ...
    def show_login_screen(self):
        ...
        #img = Image.open("1.png")           # เปิดไฟล์รูป
        #img = img.resize((200, 150))        # ปรับขนาด (ถ้าต้องการ)
        #photo = ImageTk.PhotoImage(img)     # แปลงเป็นภาพสำหรับ Tkinter

        # แสดงบน Label
        #label = Label(root, image=photo)
        #label.image = photo   # ป้องกันรูปหาย (garbage collected)
        #label.pack()
